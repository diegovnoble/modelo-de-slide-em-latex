% TODO
% 1. Develop a 'challenge' slide model
% 2. Develop a shortcut to the red arrow (\myemph{$\rightarrow$})
% 3. Fix vertical space before a math env (align, gather, multiline, equation, etc)
% 4. Prepare my own slide env to avoid writing \vspace{\stretch(1)} everytime...
% 5. Normalize citations to abnt2
\documentclass[
    mode=present,
    style=dvn,
    paper=screen,
...
\usepackage{amsmath,amsthm,amssymb,amsfonts,mathtools,array}
\usepackage{tcolorbox}
%\usepackage{enumitem} % seems to not work with latex old compilation method
